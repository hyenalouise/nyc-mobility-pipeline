...
```
--source green_taxi --input /Volumes/ftw-week-08/00-source/group_a_source/green_taxi/*.parquet --evidence /tmp/source_gate_green_taxi.json --record-control --code-revision {{job.parameters.code_revision}}
```
